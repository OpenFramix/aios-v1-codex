...
Registry of every system this AIOS can reach. Filled by `/onboard` from Q4 answers; expanded over time as tools get wired. `/audit` checks this file for domain coverage and freshness.
